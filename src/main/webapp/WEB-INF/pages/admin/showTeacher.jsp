				...
				<div class="panel panel-default">
					...
					<div class="panel-footer">
						<nav style="text-align: center">
							<ul class="pagination">
								<li>
									<a style="color: rgb(229,64,101);" aria-label="Previous" href="${pageContext.request.contextPath}/admin/showTeacher?page=1&pageSize=${teacherPageInfo.pageSize}">首页</a>
								</li>
								<li><a style="color: rgb(229,64,101);" href="${pageContext.request.contextPath}/admin/showTeacher?page=${teacherPageInfo.pageNum-1}&pageSize=${teacherPageInfo.pageSize}">上一页</a></li>

								<c:forEach begin="1" end="${teacherPageInfo.pages}" var="i">
									<c:if test="${i==teacherPageInfo.pageNum}">
										<li><a style="background-color: rgba(227,74,108,0.7);color: rgba(229,64,101);" href="${pageContext.request.contextPath}/admin/showTeacher?page=${i}&pageSize=${teacherPageInfo.pageSize}">${i}</a></li>
									</c:if>
									<c:if test="${i!=teacherPageInfo.pageNum}">
										<li><a style="color: rgb(229,64,101);" href="${pageContext.request.contextPath}/admin/showTeacher?page=${i}&pageSize=${teacherPageInfo.pageSize}">${i}</a></li>
									</c:if>
								</c:forEach>

								<li><a style="color: rgb(229,64,101);" href="${pageContext.request.contextPath}/admin/showTeacher?page=${teacherPageInfo.pageNum+1}&pageSize=${teacherPageInfo.pageSize}">下一页</a></li>
								<li>
									<a style="color: rgb(229,64,101);" href="${pageContext.request.contextPath}/admin/showTeacher?page=${teacherPageInfo.pages}&pageSize=${teacherPageInfo.pageSize}" aria-label="Next">尾页</a>
								</li>
							</ul>
						</nav>
					</div>
