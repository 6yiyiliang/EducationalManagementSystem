							...
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${selectCourseInfo.pages}" var="i">
									<c:if test="${i==selectCourseInfo.pageNum}">
										<li><a style="background-color: rgba(229,64,101,0.15)" href="${pageContext.request.contextPath}/admin/selectCourse?page=${i}&pageSize=${selectCourseInfo.pageSize}">${i}</a></li>
									</c:if>
									<c:if test="${i!=selectCourseInfo.pageNum}">
