                        ...
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" end="${selectStudentInfo.pages}" var="i">
                                <c:if test="${i==selectStudentInfo.pageNum}">
                                    <li><a style="background-color: rgba(229,64,101,0.15)" href="${pageContext.request.contextPath}/admin/selectStudent?page=${i}&pageSize=${selectStudentInfo.pageSize}">${i}</a></li>
                                </c:if>
                                <c:if test="${i!=selectStudentInfo.pageNum}">
