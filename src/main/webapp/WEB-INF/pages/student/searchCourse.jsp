							...
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${searchCourseInfo.pages}" var="i">
									<c:if test="${i==searchCourseInfo.pageNum}">
										<li><a style="background-color: rgba(227,74,108,0.7)" href="${pageContext.request.contextPath}/student/searchCourse?page=${i}&pageSize=${searchCourseInfo.pageSize}">${i}</a></li>
									</c:if>
									<c:if test="${i!=searchCourseInfo.pageNum}">
